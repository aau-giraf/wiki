...
The Visual Tangible Artifacts (VTA) project is stored in the GitHub repository [Visual Tangible Artefacts](https://github.com/aau-giraf/visual-tangible-artefacts)  – in order to get this repository, you need to have installed Git locally. See this [guide](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git) if you don't have it already (if you're on a Mac, Git is installed during the installation guide for GIRAF).

To clone each of this repository, create a directory, where you want your files to be kept. Be mindful of **not** storing the project in Dropbox, Google Drive or similar, as it might introduce unwanted behaviour, especially with file permissions etc., which isn't fun to debug.
