...
The goal of this release was to improve the general stability of the application. By implementing as well as adding features requested by the customer.


## Completed Issues

In the following, a list of the issues completed in the different repositories will be shown.
...
[80](https://github.com/aau-giraf/api_client/issues/80) |As a developer I would like an interface for the offline features |[83](https://github.com/aau-giraf/api_client/issues/83)  
...
Based on the implemented issues, the following have been accomplished:
 - Searching no longer case sensitive
 - Stop buttins on timers have become restart button.
 - Guardians can unmark completed activities
 - Citizens can reeenter completed activities
 - Guardians can log out from the "Show activity" screens
 - Moving weekplans optimized, so it no longer reloads the entire weekplan.
 - Added more faster, and better notifications when errors occour.
