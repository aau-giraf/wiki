...
1. Each crossgroup are assigned a number of issues to time estimate using **planning poker**.
...
1. Make a new branch named ``releasefix/#IssueNumber``, branched out from the release branch.
